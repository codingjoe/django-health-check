...
Monitor the health of cloud provider services. Use their public RSS/Atom status feeds or APIs.
...
Use these classes to write custom status page proxy checks.
Subclasses must implement the required attributes as documented.
